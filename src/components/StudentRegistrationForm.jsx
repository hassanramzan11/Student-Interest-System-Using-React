...
const StudentRegistrationForm = ({setTableData, tableData}) => {
  ...
  const handleSubmit = (e) => {
    ...
    const timestamp = new Date(); // Add this line to get the current timestamp
          ...
          <div className="form">
            ...
            <div className="inputfield">
              ...
              <div className="custom_select">
                <select id="city" name="city" required="" onChange={handleInputChange}>
            ...
            <div className="inputfield">
              ...
              <div className="custom_select">
                <select id="interest" name="interest" required="" onChange={handleInputChange}>
            ...
            <div className="inputfield">
              ...
              <div className="custom_select">
                <select id="department" name="department" required="" onChange={handleInputChange}>
            ...
            <div className="inputfield">
              ...
              <div className="custom_select">
                <select id="degree" name="degreeTitle" required="" onChange={handleInputChange}>
